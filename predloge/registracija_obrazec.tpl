...
<body class="playingCards fourColours rotateHand">
    ...
    <div class="row row-height1">
        ...
        <div class="prijava">
        <div class="padding">
        <p>Če že imate uporabniški račun nadaljujte na <a href="/">prijavo</a>.</p>
        </div>

        <form method="POST" action="/registriraj">
            <div class="padding">
            <p>
                Uporabniško ime: 
            ...
            <p>
                Ponovite geslo: 
                <input type="password" name="potrditev" />
            </p>
            </div>

            <input class="padding" type="submit" value="Registracija" />
        </form>   
        </div>
        </div>
        <div class="col-lg-4">
