...
<body class="playingCards fourColours rotateHand">
    ...
    <div class="row row-height2">
        ...
        <div class="col-lg-4">
        % if aktivna_igra['rezultat'] == 1 and aktivna_igra['igralceva_vsota'] == 21:
        <div class="rezultat"> BLACKJACK !! ZMAGAL SI! </div>
        % end 

        % if aktivna_igra['rezultat'] == 1 and aktivna_igra['igralceva_vsota'] < 21:
        <div class="rezultat">ZMAGAL SI!</div>
        % end

        % if aktivna_igra['rezultat'] == 2:
        <div class="rezultat">IZGUBIL SI!</div>
        % end

        % if aktivna_igra['rezultat'] == 3:
        <div class="rezultat">NEODLOCENO!</div>
        % end

        % if aktivna_igra['rezultat'] in [1, 2, 3]:
        <div>
        <a class="special-button" href="/igra">IGRAJ PONOVNO</a>
        <a class="special-button" href="/">HOME</a>
        </div>
        % end
        </div>
        <div class="col-lg-4">
